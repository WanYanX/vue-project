        ...
        <div class="content">
            ...
            <div class="diary-card">
                ...
                <div class="session">
                    <p>当前情绪：</p>
                    <div class="rate">
                        <el-rate v-model="diaryForm.moodScore" :texts="emotionStatus" :max="10" show-text
                            size="large"></el-rate>
                    </div>
                </div>
            </div>
            ...
            <div class="diary-card">
                ...
                <div class="detail-form">
                    <div class="form-group">
                        ...
                        <el-input v-model="diaryForm.emotionTriggers" placeholder="今天什么事情影响了您的情绪" type="textarea"
                            :rows="3" maxlength="1000" show-word-limit />
                    </div>
                    <div class="form-group">
                        <div class="form-label">今日感想</div>
                        <el-input v-model="diaryForm.diaryContent" placeholder="今天您的感想" type="textarea" :rows="5"
                    ...
                    <div class="life-indicators">
                        <div class="indicator-group">
                            ...
                            <el-select v-model="diaryForm.sleepQuality" placeholder="请选择">
                                ...
                                <el-option label="极好" :value="5"></el-option>
                            </el-select>
                        </div>
                        <div class="indicator-group">
