...
<template>
    <div>
        ...
        <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="emotionTriggers" label="情绪触发的因素" width="120" />
            ...
            <el-table-column label="操作" width="240" fixed="right">
                <template #default="scope">
                    ...
                    <el-button @click="deleteSession(scope.row)" text type="danger">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
                ...
                <div class="detail-section">
                    ...
                    <div class="ai-analysis-result">
                        ...
                        <div class="ai-suggestion-section">
                            <h5>专业建议</h5>
                            <p class="suggestion-content">{{ aiData.suggestion || '无' }}</p>
                        </div>
                        <div class="ai-risk-section">
                            <h5>风险描述</h5>
                            <p class="risk-content">{{ aiData.riskDescription || '无' }}</p>
                        </div>
...
const formItem = [
    { component: 'input', label: '用户id', prop: 'userId', placeholder: '请输入用户id' },
    {
        component: 'select', label: '情绪评分', prop: 'moodScoreRange', placeholder: '请选择情绪评分范围', options: [
