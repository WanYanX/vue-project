    ...
    <div class="consultation-container">
        <div class="sidebar">
            ...
            <div class="ai-assistant-info">
                <div class="breathing-circle">
                    <el-image :src="iconUrl" style="width: 25px; height: 25px;" alt="AI助手图标" class="assistant-icon" />
                </div>
            ...
            <div class="emotion-garden">
                ...
                <div class="warm-tips">
                    <div class="emotion-status-text">
                        ...
                        <span class="status-emotion">{{ currentEmotion.isNegative ? '需要关注' : '心情不错' }}</span>
                    </div>
            ...
            <div class="session-history">
                ...
                <div class="session-list">
                    <div v-for="item in sessionList" :key="item.id" @click="handleSessionClick(item)"
                        class="session-item">
                        ...
                        <div class="session-actions">
                            <el-button type="danger" text size="mini" @click="handleDeleteSession(item.id)">
                                <el-icon>
                                    <DeleteFilled />
                                </el-icon>
                            </el-button>
        ...
        <div class="chat-main">
            <div class="chat-header">
                ...
                <!-- 右侧按钮 -->
                <el-button circle @click="createNewFrontendSession" title="新建新咨询">
                    <el-icon>
                        <Plus />
                    </el-icon>
                </el-button>
            ...
            <div class="chat-messages">
                ...
                <div v-for="msg in messages" :key="msg.id" class="message-item"
                    ...
                    <div class="message-avatar">
                        <el-image v-if="msg.senderType === 1" :src="userUrl" style="width: 18px; height: 18px;"
                            alt="用户图标" />
            ...
            <div class="chat-input">
                <div class="input-container">
                    <el-input v-model="userMessage" placeholder="请输入你想要分享的内容" type="textarea" :rows="3"
                        :disabled="isAityping" @keydown="handleKeyDown" class="message-input"></el-input>
                ...
                <el-button :disabled="userMessage.length > 500 || !userMessage.trim()" type="primary" class="send-btn"
                    @click="sendMessage">
                    <el-icon>
                        <Promotion />
                    </el-icon>
...
const sendMessage = () => {
    ...
    if (currentSession.value.status === 'TEMP') {
        stratNewSession(currentSession.value.sessionId, message)
    } else {
        // 继续当前会话
        messages.value.push({
            id: Date.now(),
        ...
        startAIRespone(currentSession.value.sessionId, message)
    }
}

const stratNewSession = (sessionId, message) => {
    // 构建一个会话的参数
    const SessionParams = {
    ...
    if (currentSession.value.sessionTitle === '新对话') {
        SessionParams.sessionTitle = `${new Date().toLocaleString()}会话`
    }
    else {
        //会话历史记录
...
const startAIRespone = (sessionId, userMessage) => {
    //防止重复发送
    if (isAityping.value) {
    ...
    fetchEventSource('/api/psychological-chat/stream',
        {
            ...
            onerror: (error) => {
                handleError(error.message || 'Ai回复失败')
                throw error
            },
            onclose: () => {
                //开始情绪分析
