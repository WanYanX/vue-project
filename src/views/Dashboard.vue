                ...
                <el-card v-if="aiData.systemOverview">
                    <div class="card-content">
                        <div class="avatar users">
                            <el-image style="width: 40px; height: 40px;" :src="iconUrl1" alt="用户图标" />
                        </div>
                        <div class="info">
                ...
                <el-card v-if="aiData.systemOverview">
                    <div class="card-content">
                        <div class="avatar like">
                            <el-image style="width: 40px; height: 40px;" :src="iconUrl2" alt="点赞图标" />
                        </div>
                        <div class="info">
                ...
                <el-card v-if="aiData.systemOverview">
                    <div class="card-content">
                        <div class="avatar comments">
                            <el-image style="width: 40px; height: 40px;" :src="iconUrl3" alt="评论图标" />
                        </div>
                        <div class="info">
                ...
                <el-card v-if="aiData.systemOverview">
                    <div class="card-content">
                        <div class="avatar smile">
                            <el-image style="width: 40px; height: 40px;" :src="iconUrl4" alt="笑脸图标" />
                        </div>
                        <div class="info">
                ...
                <el-card style="width: 100%;">
                    ...
                    <div class="chart-content">
                        <div v-if="aiData.consultationStats" class="consultation-stats">
                            <div class="stat-item">
                                <div class="stat-label">咨询会话总数</div>
...
const initEmotionChart = () => {
    ...
    if (!aiData.value.emotionTrend) return
...
const initConsultationChart = () => {
    // console.log('consultationChartRef.value:', consultationChartRef.value)
    // console.log('aiData.value.consultationStats:', aiData.value.consultationStats)
    // console.log('aiData.value.consultationStats?.dailyTrend:', aiData.value.consultationStats?.dailyTrend)
    ...
    //获取咨询会话统计数据
    const dailyTrends = aiData.value.consultationStats.dailyTrend
    ...
    const option = {
        ...
        xAxis: {
            type: 'category',
            data: dailyTrends.map(item => item.date),
            axisLine: {
                lineStyle: {
        ...
        series: [
            {
                name: '会话数量',
                type: 'bar',
                data: dailyTrends.map(item => item.sessionCount),
                itemStyle: {
                    color: {
                        type: 'linear',
                        x: 0,
            ...
            },
            {
                name: '参与用户数',
                type: 'bar',
                data: dailyTrends.map(item => item.userCount),
                itemStyle: {
                    color: {
                        type: 'linear',
                        x: 0,
